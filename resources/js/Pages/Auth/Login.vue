...
<template>
    <GuestLayout>
        ...
        <div class="flex justify-center items-center">
            <a href="login/redirect" type="submit" class="bg-battlenet transition border-2 border-battlenet hover:border-battlenet-light w-full rounded-full flex items-center justify-center text-white px-5 py-2">
                Logg inn med
                <svg class="ml-4 mr-2 h-14 w-32" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
